		...
		res.on('data', function (chunk) {
  		...
  		res.on('end', function () {
       		...
       		if (action == 'check') {
       			...
       			self.info.coinbase = "Shift " + jsonObject["version"] + " Build:(" +jsonObject["build"]+")";
				self.info.node = "Shift " + jsonObject["version"] + " Build:(" +jsonObject["build"]+")";
...
Node.prototype.startConnection = function() {
	console.info('Starting connection to Shift Node');
